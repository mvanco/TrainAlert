...
public class TaConfig {
    ...
    public static final String REST_BASE_URL = "http://192.168.137.1:5000"; // Application server with offline maps
    ...
    public static final int TRIP_FRAGMENT_PREVIOUS_STOP_COUNT = 0;
    public static final int TRIP_FRAGMENT_NEXT_STOP_COUNT = 3;
